...
- (void)applicationWillResignActive:(UIApplication *)application {
    ...
    [[Storage instance] log:@"app will resign active" from:@"main"];
}
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
    ...
    [[Storage instance] log:@"app did enter background" from:@"main"];
}


- (void)applicationWillEnterForeground:(UIApplication *)application {
    // Called as part of the transition from the background to the active state; here you can undo many of the changes made on entering the background.
    [[Storage instance] log:@"app will enter foreground" from:@"main"];
}
...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    [[Storage instance] log:@"app become active" from:@"main"];
}
...
-(void)applicationSignificantTimeChange:(UIApplication *)application{
    [[Storage instance] log:@"app significant time change" from:@"main"];
}
-(void)applicationDidReceiveMemoryWarning:(UIApplication *)application{
    [[Storage instance] log:@"app did receive memory warning" from:@"main"];
}
